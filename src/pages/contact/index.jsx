        ...
        <div className="w-[80%]  gap-20 flex justify-between items-stretch">
          <div className="w-1/2 h-full">
            <div className=" grid grid-cols-2 space-y-20">
              <div className="">
                <h2 className=' mb-2 text-xl uppercase opacity-70'>location</h2>
                <p className='text-lg' >Mumbai, India</p>
              </div>
              <div className="">
                <h2 className=' mb-2 text-xl uppercase opacity-70'>email</h2>
                <a href="">
              ...
              <div className="">
                <h2 className=' mb-2 text-xl uppercase opacity-70'>contact</h2>
              ...
              <div className="">
                <h2 className=' mb-2 text-xl uppercase opacity-70'>socials</h2>
