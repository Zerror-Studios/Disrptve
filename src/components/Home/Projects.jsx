            ...
            <div className="w-full py-32 ">
                ...
                <div className="w-full grid-cols-4 pt-32 grid px-5">
                    <a href='/project/1' data-aos-anchor-placement="top-bottom"
                        data-aos="clip" className=" group aspect-[16/12] border border-[#fb05013d] relative col-span-2 flex items-end">
                    ...
                    <div data-aos-anchor-placement="top-bottom"
                        data-aos="clip" className="aspect-[16/12] border border-[#fb05013d]  relative col-span-2">
                    ...
                    <a href='/project/2' data-aos-anchor-placement="top-bottom"
                        data-aos="clip"
                        className=" group aspect-square border border-[#fb05013d]  relative col-span-1 flex items-end">
                    ...
                    <div data-aos-anchor-placement="top-bottom"
                        data-aos="clip"
                        className="aspect-square border border-[#fb05013d]  relative col-span-1">
                    ...
                    <a href='/project/6' className=" group cursor-pointer border border-[#fb05013d]  relative col-span-2 flex items-end">
                        ...
                        <div className="flex w-full px-5 py-5 items-center justify-between group-hover:text-black group-hover:font-semibold transition-colors duration-700">
                            <div className="relative">
                                <div className="w-0 group-hover:w-[100%] transition-all duration-300  h-[2px] bg-black absolute bottom-0 left-0"></div>
