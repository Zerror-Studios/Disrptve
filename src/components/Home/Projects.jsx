        ...
        <>
            <div className="w-full py-14 lg:py-32 ">
                ...
                <div className=" hidden  w-full md:grid-cols-4 pt-14 lg:pt-32 md:grid px-3 lg:px-5">
                    ...
                    <a href='/projects/4' className=" group  border border-[#8585855b] relative col-span-4 flex items-end">
                        <div className="flex w-1/2 px-3 lg:px-5 py-3 lg:py-5 items-center justify-between group-hover:text-[#FB0401] group-hover:font-semibold transition-colors duration-300">
                            <div className="">
                                <h2 className=' text-xl lg:text-3xl anim-tx-y   leading-tight'>PROOST</h2>
                                <p className=' text-base lg:text-xl anim-tx-y'> Alcohol Beverages</p>
                            </div>
                    ...
                    <a href='/projects/8'
                        ...
                        <div className="flex aspect-square w-1/2 px-3 lg:px-5 py-3 lg:py-5 items-end justify-between group-hover:text-[#FB0401] ont-semibold transition-colors duration-300">
                            <div className="">
                                <h2 className=' text-xl lg:text-3xl anim-tx-y  leading-tight font-semibold uppercase'>Imagine</h2>
                                <p className=' text-base lg:text-xl anim-tx-y'>Plant-Based Meat</p>
                            </div>
                    ...
                    <a href='/projects/9'
                        ...
                        <div className="flex aspect-square w-1/2 px-3 lg:px-5 py-3 lg:py-5 items-end justify-between group-hover:text-[#FB0401] ont-semibold transition-colors duration-300">
                            <div className="">
                                <h2 className=' text-xl lg:text-3xl anim-tx-y  leading-tight font-semibold uppercase'>SuperYou</h2>
                                <p className=' text-base lg:text-xl anim-tx-y'>Retail and Health & Nutrition</p>
                            </div>
                            <RiArrowRightUpLine size={26} />
                        </div>
                        <div
                    ...
                    <a href='/projects/1' className=" group  border border-[#8585855b] relative col-span-4 flex items-end">
                        <div className="aspect-[16/12] border border-[#8585855b]  relative w-1/2">
                        ...
                        <div className="flex w-1/2 px-3 lg:px-5 py-3 lg:py-5 items-center justify-between group-hover:text-[#FB0401] group-hover:font-semibold transition-colors duration-300">
                            <div className="">
                                <h2 className=' text-xl lg:text-3xl anim-tx-y font-semibold uppercase  leading-tight'>Devgn CinEx</h2>
                                <p className=' text-base lg:text-xl anim-tx-y'>Entertainment</p>
                            </div>
                            <RiArrowRightUpLine size={32} />
                        </div>
                    </a>
                    ...
                    <a href='/projects/6'
                        ...
                        <div className="flex aspect-square w-1/2 px-3 lg:px-5 py-3 lg:py-5 items-end justify-between group-hover:text-[#FB0401] ont-semibold transition-colors duration-300">
                            <div className="">
                                <h2 className=' text-xl lg:text-3xl anim-tx-y  leading-tight font-semibold uppercase'>Punjab Kings</h2>
                                <p className=' text-base lg:text-xl anim-tx-y'>Sports</p>
                            </div>
                            <RiArrowRightUpLine size={26} />
                        </div>
                        <div
                    ...
                    <a href='/projects' className=" group cursor-pointer border border-[#8585855b]  relative col-span-2 flex items-end">
                        ...
                        <div className="flex w-full px-3 lg:px-5 py-3 lg:py-5 items-center justify-between group-hover:text-[#FB0401] group-hover:font-semibold transition-colors duration-300">
                            <div className="relative">
                                ...
                                <h2 className=' text-xl lg:text-3xl anim-tx-y group-hover:italic uppercase '>view all our works</h2>
                            </div>
                            <RiArrowRightUpLine size={32} />
                        </div>
                    </a>
