...
//     // prevent ScrollTrigger from refreshing after DOM is gone
//     gsap.ticker.remove(ScrollTrigger.update);
//     if (mainTl.scrollTrigger && mainTl.scrollTrigger.kill) {
//       mainTl.scrollTrigger.kill(false);
//     }
//     if (mainTl.kill) mainTl.kill();
//     ScrollTrigger.refresh(true); // soft refresh to prevent ghost pin spacers
//   };
// }
